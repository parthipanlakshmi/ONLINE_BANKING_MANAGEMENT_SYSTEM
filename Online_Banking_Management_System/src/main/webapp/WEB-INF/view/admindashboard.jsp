...
<body>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						...
						<h2 class="text-muted">Check Customers</h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						...
						<h2 class="text-muted">Check Accounts</h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						...
						<h2 class="text-muted">Check Transaction</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header custom-bg text-white text-center">
					<h5 class="modal-title" id="exampleModalLongTitle" style="color: black;">Total
						Customer</h5>
						...
						<table class="table">
							<thead style="color: black;">
								<tr>
									...
									<th scope="col">Chequebook Status</th>
									<th scope="col">Approve Chequebook</th>
								</tr>
							</thead>
							<tbody>
								<%
								...
								<tr>
									...
									<td class="mid-align"><a
										href="changeAccountStatus?accountId=<%=acc.getId()%>&accountStatus=<%=Constants.AccountStatus.LOCK.value()%>"><button
												type="button"  style="color: black;">Deactivate</button>
									</a></td>
									<%
									} else {
									%>
									<td class="mid-align"><a
										href="changeAccountStatus?accountId=<%=acc.getId()%>&accountStatus=<%=Constants.AccountStatus.OPEN.value()%>"><button
												type="button"  style="color: black;">Activate</button>
									</a></td>
									<%
									}
									%>
									...
									%>
									   <td class="mid-align"><a
										href="updateCheckbookStatus?customerId=<%=cust.getId()%>&status=<%=Constants.CheckbookStatus.APPROVED.value()%>"><button
												type="button" class="btn custom-bg text-white" style="color: black;">Approve</button></a></td>
									<%
									}
	...
	<div class="modal fade" id="show-transaction-modal" tabindex="-1"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header custom-bg text-white text-center">
					<h5 class="modal-title" id="exampleModalLongTitle" style="color: black;">Total Transactions</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
