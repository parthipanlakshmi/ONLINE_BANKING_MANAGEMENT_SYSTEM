...
<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
   ...
   <b><span class="text-color">Online Banking Management System</span></b>
  </a>
  ...
  else if(userlogin != null && userlogin.equals("admindto")) {
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
     ...
     %>
      ...
      <li class="nav-item active  ml-5">
        <a class="nav-link" href="updateuser"><b><span class="text-color">Update Customer Details</span></b><span class="sr-only">(current)</span></a>
      </li>
...
<div class="modal fade balancemodal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title" id="exampleModalLongTitle" style="color: black;">Total Balance</h5>
...
<div class="modal fade fetchmodal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title" id="exampleModalLongTitle" style="color: black;">My Account Detail</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div> 
          ...
          <b class="text-center">
            ...
            <a
										href="requestCheckbook?customerId=<%=customer.getId()%>"><button
												type="button" class="btn custom-bg-2 text-black custom-bg">Request Chequebook</button>
									</a>
            <%	 
             }
             ...
             %>
                 Chequebook Status : <%= checkbook.getApprovalStatus() %><br>
             <%	 
             }
...
<div class="modal fade history" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="color: black;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title" id="exampleModalLongTitle"  style="color: black;">My Account Detail</h5>
  ...
  <thead class="custom-bg text-white">
    <tr>
      ...
      <th scope="col" style="color: black;">To Card No</th>
      <th scope="col" style="color: black;">Transaction Type</th>
      <th scope="col" style="color: black;">Transaction Date</th>
    </tr>
  </thead>
