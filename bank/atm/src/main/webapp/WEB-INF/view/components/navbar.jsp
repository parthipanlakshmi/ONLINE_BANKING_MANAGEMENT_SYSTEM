<%@ page import ="com.atm.model.*"%>
    <%@ page import ="com.atm.dao.*"%>
    <%@ page import ="com.atm.utility.*"%>
...
<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
    <img src="resources/images/banking_logo.png" width="40" height="40" class="d-inline-block align-top" alt="">
